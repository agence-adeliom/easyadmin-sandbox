...
class BaseCategoryEntity {
    ...
    /**
     * @var BasePostEntity[]|ArrayCollection
     */
    protected $posts;
    ...
    /**
     * @return BasePostEntity[]|ArrayCollection
     */
    ...
    public function addPost(BasePostEntity $post): void
    {
        $this->posts->add($post);
    ...
    public function removePost(BasePostEntity $post): void
    {
