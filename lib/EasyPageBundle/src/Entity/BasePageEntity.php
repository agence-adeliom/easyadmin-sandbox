 ...
 * @ORM\MappedSuperclass(repositoryClass="Adeliom\EasyPageBundle\Repository\BasePageRepository")
 */
class BasePageEntity {
    ...
    /**
     * @var null|BasePageEntity
     *
     * @Assert\Type(BasePageEntity::class)
     */
    protected $parent;

    /**
     * @var BasePageEntity[]|ArrayCollection
     */
    protected $children;
    ...
    public function setParent(?BasePageEntity $parent = null)
    {
        if ($parent === $this) {
    ...
    /**
     * @return BasePageEntity[]|ArrayCollection
     */
    ...
    public function addChildren(BasePageEntity $page): void
    {
    ...
    public function removeChildren(BasePageEntity $page): void
    {
