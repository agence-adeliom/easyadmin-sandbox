...
namespace Adeliom\EasyShop\BasketBundle\Controller;

use Adeliom\EasyShop\BasketBundle\Form\AddressType;
...
class BasketController extends AbstractController
{
    ...
    {
        $form = $form ?: $this->createForm(BasketType::class, $this->get('easy_shop.basket'), [
        ...
        $this->get('session')->set('easy_shop_basket_delivery_redirect', 'easy_shop_basket_delivery_address');
        ...
        return $this->render('@SonataBasket/Basket/index.html.twig', [
            'basket' => $this->get('easy_shop.basket'),
    ...
    {
        $form = $this->createForm(BasketType::class, $this->get('easy_shop.basket'), ['validation_groups' => ['elements']]);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return new RedirectResponse($this->generateUrl('easy_shop_basket_index'));
        }
    ...
    public function addProductAction(Request $request)
    {
        ...
        $product = $this->get('easy_shop.product.set.manager')->findOneBy(['id' => $params['productId']]);
        ...
        $formBuilder = $this->get('form.factory')->createNamedBuilder('add_basket', FormType::class, null, [
            'data_class' => $this->container->getParameter('easy_shop.basket.basket_element.class'),
    ...
    {
        $this->basketFactory->reset($this->get('easy_shop.basket'));
    ...
    {
        $customer = $this->get('easy_shop.customer.selector')->get();
        ...
        return new RedirectResponse($this->generateUrl('easy_shop_basket_delivery_address'));
    }
    ...
    public function paymentStepAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return new RedirectResponse($this->generateUrl('easy_shop_basket_final'));
        }
    ...
    public function deliveryStepAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return new RedirectResponse($this->generateUrl('easy_shop_basket_payment_address'));
        }
    ...
    public function deliveryAddressStepAction(Request $request)
    {
        ...
        $em = $this->container->get('easy_shop.address.manager')->getEntityManager();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($form->has('useSelected') && $form->get('useSelected')->isClicked()) {
                ...
                $this->get('easy_shop.customer.manager')->save($customer);
            ...
            return new RedirectResponse($this->generateUrl('easy_shop_basket_delivery'));
        }

        // Set URL to be redirected to once edited address
        $this->get('session')->set('easy_shop_address_redirect', $this->generateUrl('easy_shop_basket_delivery_address'));
    ...
    public function paymentAddressStepAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return new RedirectResponse($this->generateUrl('easy_shop_basket_payment'));
        }

        // Set URL to be redirected to once edited address
        $this->get('session')->set('easy_shop_address_redirect', $this->generateUrl('easy_shop_basket_payment_address'));
