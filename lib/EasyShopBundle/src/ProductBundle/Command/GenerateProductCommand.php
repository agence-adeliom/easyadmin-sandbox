...
namespace Adeliom\EasyShop\ProductBundle\Command;

use Adeliom\EasyShop\Component\Generator\Mustache;
...
class GenerateProductCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setName('easyshop:product:generate')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): void
    {
        ...
        $bundle = $this->kernel->getBundle('EasyShopProductBundle', false);
...
<comment>services:</comment>
    {{ service }}.manager:
        class: Adeliom\EasyShop\ProductBundle\Entity\ProductManager
        arguments:
            - App\Adeliom\EasyShop\ProductBundle\Entity\{{ product }}
            - "@doctrine"

    {{ service }}.type:
        class: App\Adeliom\EasyShop\ProductBundle\Provider\{{ product }}ProductProvider
        arguments:
            - "@jms_serializer"

<info>2. Add this service configuration</info>

<comment>easy_shop_product:</comment>
    products:
        {{ service }}:
...
Add this line in <comment>/src/Sonata/ProductBundle/Resources/config/serializer/Entity.Product.xml</comment>
    ...
    <discriminator-class value="{{ service }}">App\Adeliom\EasyShop\ProductBundle\Entity\{{ product }}</discriminator-class>
