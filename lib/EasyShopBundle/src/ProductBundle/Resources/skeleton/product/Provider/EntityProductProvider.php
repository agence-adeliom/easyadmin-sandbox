...
namespace {{ namespace_prefix }}Shop\ProductBundle\Provider;

use Adeliom\EasyShop\ProductBundle\Model\BaseProductProvider;
use App\Adeliom\EasyShop\ProductBundle\Controller\{{ product }}Controller;
