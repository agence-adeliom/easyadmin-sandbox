...
use Adeliom\EasyShop\Component\Basket\InvalidProductException;
use Adeliom\EasyShop\Component\Currency\CurrencyInterface;
use Adeliom\EasyShop\Component\Currency\CurrencyPriceCalculatorInterface;
use Adeliom\EasyShop\Component\Delivery\ServiceDeliveryInterface;
use Adeliom\EasyShop\Component\Event\AddBasketElementEvent;
use Adeliom\EasyShop\Component\Event\AfterCalculatePriceEvent;
use Adeliom\EasyShop\Component\Event\BasketEvents;
use Adeliom\EasyShop\Component\Event\BeforeCalculatePriceEvent;
use Adeliom\EasyShop\Component\Form\Transformer\QuantityTransformer;
...
use Adeliom\EasyShop\FormatterBundle\Form\Type\FormatterType;
...
abstract class BaseProductProvider implements ProductProviderInterface
{
    ...
    /**
     * @return \Adeliom\EasyShop\Component\Currency\CurrencyPriceCalculatorInterface
     */
    ...
    /**
     * @return \Adeliom\EasyShop\Component\Basket\BasketElementManagerInterface
     */
    ...
    /**
     * @param \Adeliom\EasyShop\Component\Basket\BasketElementInterface $basketElement A basket element instance
     * @param string                                          $format        A format to obtain raw product
     *
     * @return \Adeliom\EasyShop\Component\Order\OrderElementInterface
     */
    ...
    /**
     * @see \Adeliom\EasyShop\Component\Product\ProductProviderInterface::createBasketElement()
     *
     * @return object
     */
     ...
     *
     * @param \Adeliom\EasyShop\Component\Product\ProductInterface $product      A EasyShop product instance
     ...
     *
     * @throws \Adeliom\EasyShop\Component\Basket\InvalidProductException
     *
     * @return bool|\Adeliom\EasyShop\Component\Basket\BasketElementInterface
     */
