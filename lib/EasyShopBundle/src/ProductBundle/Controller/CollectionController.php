...
use Adeliom\EasyShop\ClassificationBundle\Model\CollectionManagerInterface;
...
use Adeliom\EasyShop\SeoBundle\Seo\SeoPage;
...
class CollectionController extends AbstractController
{
    ...
    {
        $pager = $this->get('easy_shop.classification.manager.collection')
    ...
    {
        $pager = $this->get('easy_shop.product.set.manager')
    ...
    {
        $collection = $collection ?: $this->get('easy_shop.classification.manager.collection')->getRootCollection();
    ...
    private function getCollectionManagerInterface(): CollectionManagerInterface
    {
        if (!$this->collectionManagerInterface) {
            return $this->get('easy_shop.classification.manager.collection');
        }
    ...
    private function getSeoManager(): SeoPage
    {
        if (!$this->sonataSeoPage) {
            return $this->get('easy_shop.seo.page');
        }
