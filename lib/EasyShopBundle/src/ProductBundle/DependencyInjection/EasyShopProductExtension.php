...
class EasyShopProductExtension extends Extension
{
    ...
    {
        $container->setParameter('easy_shop.product.product.class', $config['class']['product']);
        $container->setParameter('easy_shop.product.package.class', $config['class']['package']);
        $container->setParameter('easy_shop.product.product_category.class', $config['class']['product_category']);
        $container->setParameter('easy_shop.product.product_collection.class', $config['class']['product_collection']);
        $container->setParameter('easy_shop.product.category.class', $config['class']['category']);
        $container->setParameter('easy_shop.product.collection.class', $config['class']['collection']);
        $container->setParameter('easy_shop.product.delivery.class', $config['class']['delivery']);

        $container->setParameter('easy_shop.product.admin.product.entity', $config['class']['product']);
        $container->setParameter('easy_shop.product.admin.package.entity', $config['class']['package']);
        $container->setParameter('easy_shop.product.admin.product_category.entity', $config['class']['product_category']);
        $container->setParameter('easy_shop.product.admin.product_collection.entity', $config['class']['product_collection']);
        $container->setParameter('easy_shop.product.admin.category.entity', $config['class']['category']);
        $container->setParameter('easy_shop.product.admin.collection.entity', $config['class']['collection']);
        $container->setParameter('easy_shop.product.admin.delivery.entity', $config['class']['delivery']);
    }
    ...
    protected function registerSeoParameters(ContainerBuilder $container, array $config): void
    {
        ...
        foreach ($productSeo as $key => $value) {
            $container->setParameter(sprintf('easy_shop.product.seo.product.%s', $key), $value);
        }
    }
}
