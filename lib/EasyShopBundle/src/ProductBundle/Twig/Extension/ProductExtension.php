...
namespace Adeliom\EasyShop\ProductBundle\Twig\Extension;
...
class ProductExtension extends \Twig_Extension
{
    ...
    /**
     * @param ProductPool          $productPool        EasyShop product pool
     * @param FormFactoryInterface $formFactory        Symfony form factory
     * @param string               $basketElementClass EasyShop basket element class name
     */
    ...
    {
        return [
            new \Twig_SimpleFunction('easy_shop_product_provider', [$this, 'getProductProvider']),
            new \Twig_SimpleFunction('easy_shop_product_has_variations', [$this, 'hasVariations']),
            new \Twig_SimpleFunction('easy_shop_product_has_enabled_variations', [$this, 'hasEnabledVariations']),
            new \Twig_SimpleFunction('easy_shop_product_cheapest_variation', [$this, 'getCheapestEnabledVariation']),
            new \Twig_SimpleFunction('easy_shop_product_cheapest_variation_price', [$this, 'getCheapestEnabledVariationPrice']),
            new \Twig_SimpleFunction('easy_shop_product_price', [$this, 'getProductPrice']),
            new \Twig_SimpleFunction('easy_shop_product_stock', [$this, 'getProductStock']),
            new \Twig_SimpleFunction('easy_shop_product_form_add_basket', [$this, 'getFormAddBasket']),
        ];
    }
