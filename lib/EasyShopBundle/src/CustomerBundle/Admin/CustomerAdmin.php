...
namespace Adeliom\EasyShop\CustomerBundle\Admin;
...
class CustomerAdmin extends AbstractAdmin
{
    ...
    protected function configureSideMenu(MenuItemInterface $menu, $action, ?AdminInterface $childAdmin = null): void
    {
        ...
        $menu->addChild(
            ...
            $admin->generateMenuUrl('easy_shop.customer.admin.address.list', ['id' => $id])
        );

        $menu->addChild(
            'customer.sidemenu.link_order_list',
            $admin->generateMenuUrl('easy_shop.order.admin.order.list', ['id' => $id])
        );
    }
}
