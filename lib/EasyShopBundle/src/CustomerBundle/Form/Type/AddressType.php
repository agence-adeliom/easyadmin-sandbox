...
namespace Adeliom\EasyShop\CustomerBundle\Form\Type;

use Adeliom\EasyShop\BasketBundle\Form\AddressType as BasketAddressType;
...
class AddressType extends AbstractType
{
     ...
     * @param BasketInterface $basket EasyShop e-commerce basket instance
     */
