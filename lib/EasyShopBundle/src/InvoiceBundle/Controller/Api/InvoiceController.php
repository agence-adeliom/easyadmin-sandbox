...
namespace Adeliom\EasyShop\InvoiceBundle\Controller\Api;
...
class InvoiceController
{
     ...
     *  },
     *  output={"class"="Adeliom\EasyShop\Component\Invoice\InvoiceInterface", "groups"={"easy_shop_api_read"}},
     *  statusCodes={
     ...
     *      {"name"="id", "dataType"="string", "description"="Invoice identifier"}
     *  },
     *  output={"class"="Adeliom\EasyShop\Component\Invoice\InvoiceElementInterface", "groups"={"easy_shop_api_read"}},
     *  statusCodes={
     *      200="Returned when successful",
     *      404="Returned when invoice is not found"
     *  }
