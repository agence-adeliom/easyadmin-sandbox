...
class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('easy_shop_payment');
        $node = $treeBuilder->getRootNode();

        $node
            ->children()
                ->scalarNode('selector')->defaultValue('easy_shop.payment.selector.simple')->cannotBeEmpty()->end()
                ->scalarNode('generator')->defaultValue('easy_shop.payment.generator.mysql')->cannotBeEmpty()->end()
                ->arrayNode('transformers')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('order')->defaultValue('easy_shop.payment.transformer.order')->cannotBeEmpty()->end()
                        ->scalarNode('basket')->defaultValue('easy_shop.payment.transformer.basket')->cannotBeEmpty()->end()
                    ->end()
                ->end()
            ->end();
                    ...
                    ->children()
                            ...
                            ->children()
                                ...
                                ->arrayNode('options')
                                    ->children()
                                        ...
                                        ->scalarNode('class_order')->defaultValue('App\\Adeliom\EasyShop\\OrderBundle\\Entity\\Order')->cannotBeEmpty()->end()
                                        ->scalarNode('url_callback')->defaultValue('easy_shop_payment_callback')->cannotBeEmpty()->end()
                                        ->scalarNode('url_return_ko')->defaultValue('easy_shop_payment_error')->cannotBeEmpty()->end()
                                        ->scalarNode('url_return_ok')->defaultValue('easy_shop_payment_confirmation')->cannotBeEmpty()->end()
                        ...
                        ->arrayNode('debug')
                            ->children()
                                ...
                                ->scalarNode('browser')->defaultValue('easy_shop.payment.browser.curl')->cannotBeEmpty()->end()
                                ->arrayNode('transformers')
                                    ->children()
                                        ->scalarNode('basket')->defaultValue('easy_shop.payment.transformer.basket')->cannotBeEmpty()->end()
                                        ->scalarNode('order')->defaultValue('easy_shop.payment.transformer.order')->cannotBeEmpty()->end()
                        ...
                        ->arrayNode('scellius')
                            ->children()
                                ...
                                ->scalarNode('generator')->defaultValue('easy_shop.payment.provider.scellius.none_generator')->end()
            ...
            ->children()
                ->arrayNode('class')
                    ...
                    ->children()
                        ...
                        ->scalarNode('transaction')->defaultValue('App\\Adeliom\EasyShop\\PaymentBundle\\Entity\\Transaction')->end()
                    ->end()
                ->end()
            ->end();
    }
