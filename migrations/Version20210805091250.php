 ...
 */
final class Version20210805091250 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE content content LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\'');
